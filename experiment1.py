...
if __name__=="__main__":
    ...
    def run_strategy(start_date, end_date):
        ...
        ms = manual.manualStrategy(symbol = 'JPM', sd=start_date, ed=end_date, sv = 100000)
        ...
        while i < N:
            ...
            df_orders = learner.createOrdersDataFrame(df_trades)
            portvals_strategy = msim.compute_portvals(orders_file = df_orders, start_val = 100000, commission=0, impact=0.005, end_date = end_date, start_date = start_date)
            cum_ret, sharpe_ratio, std_daily_ret, avg_daily_ret = msim.computeStatisticsReturnValues(portvals_strategy)
        ...
        print 'The average standard dev of daily returns is: ' + str(tot_std_daily_ret/N)
